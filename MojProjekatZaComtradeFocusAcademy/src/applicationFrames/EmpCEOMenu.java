 ...
 * @author Anta
 */
public class EmpCEOMenu extends javax.swing.JFrame {
...
//    Socket s;-----------------------
    ...
    public EmpCEOMenu(String username,Socket s) {
...
//        this.s = s;--------------------------------------------------
        try {
            ...
            UL4.setModel(dlm);
            idLabel4.setText(username);
            din = new DataInputStream(s.getInputStream());
            dout = new DataOutputStream(s.getOutputStream());
            new EmpCEOMenu.Read().start();
...
//                    }
    ...
    private void initComponents() {
        ...
        jPanel7.setBackground(new java.awt.Color(56, 56, 110));
        jPanel7.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));

        UL4.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        UL4.setEnabled(false);
        jScrollPane7.setViewportView(UL4);

        idLabel4.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        idLabel4.setForeground(new java.awt.Color(204, 204, 204));
        idLabel4.setText("................................");
        ...
        jLabel.setText("You are loged in as :");

        jLabel20.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        jLabel20.setForeground(new java.awt.Color(204, 204, 204));
        jLabel20.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8_businessman_30px.png"))); // NOI18N
        jLabel20.setText("Online users:");

        jLabel21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/samoLogo1.png"))); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(idLabel4, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jLabel20, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 151, Short.MAX_VALUE)))
                .addGap(31, 31, 31))
        ...
        jMenuItem4.setText("Manage Students");
...
//            }
    ...
    private void jMenuItem3MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenuItem3MousePressed
        new EmpCEOManageEmployees(username).setVisible(true);
//        this.setVisible(false);
    ...
    private void jMenuItem4MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenuItem4MousePressed
        try {
            ...
            String usernameCEOasProffesor = username.substring(4);
            
//            DataInputStream din = new DataInputStream(s.getInputStream());

            DataOutputStream dout1 = new DataOutputStream(s.getOutputStream());
            dout1.writeUTF("CEO-as-Proffesor-"+usernameCEOasProffesor);

            String i = new DataInputStream(s.getInputStream()).readUTF();
            if(i.equals("You Are Alredy Registered....!!")){
                JOptionPane.showMessageDialog(this,"Your chat is already open");
            }else{
                new EmpCEOManageStudents("CEO-as-Proffesor-"+usernameCEOasProffesor,s).setVisible(true);
...
//            s.close();------------------------------------------
    ...
    private javax.swing.JList<String> UL4;
